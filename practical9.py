...
class Result:
    ...
    def show_mark_sheet(self):
        if len(self.exam.marks_of_student) == self.exam.total_subjects:
            ...
            print(f"*************Mark-sheet of {self.exam.name}******************")
            ...
            print(f"Total marks : {sum(self.exam.marks_of_student.values())}/{self.exam.total_subjects * self.exam.get_marks_criteria()}")
...
if __name__ == "__main__":
    ExamA = Exam("Pratham Modi", 18, "MALE", 4)
